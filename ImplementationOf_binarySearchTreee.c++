...
#include<conio.h>
#include<stdlib.h>
//using namespace std; void insert(int,int ); void delte(int);
void display(int); int search(int);
...
{
case 1:
cout <<"enter the element to insert"; cin >> ch; insert(1,ch);
break; case 2:
 

cout <<"enter the element to delete"; cin >>x; y=search(1);
if(y!=-1) delte(y);
...
break; case 4:
cout <<"enter the element to search:"; cin >> x; y=search(1);
if(y == -1) cout <<"no such element in tree"; else cout <<x << "is in" <<y <<"position"; break;
case 5:
exit(0);
}
}
...
{
if(t==1)
{cout <<"no element in tree:"; return;} for(int i=1;i<40;i++) if(tree[i]==-1) cout <<" ";
